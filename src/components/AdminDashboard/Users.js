...
const Users = () => {
  ...
  useEffect(() => {
      axios.get("https://olofbankappbackend-production.up.railway.app/api/users")
  ...
  const handleDelete = () => {
    axios.delete(`https://olofbankappbackend-production.up.railway.app/api/users/${userid}`)
  ...
  const getTransactions = () => {
      ...
      axios.get("https://olofbankappbackend-production.up.railway.app/api/transactions/" + transactionID)
  ...
  const saveStatus = () => {
      axios.put(`https://olofbankappbackend-production.up.railway.app/api/transactions/${transactionID}`, {status: status})
